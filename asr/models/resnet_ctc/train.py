...
def batch_train(argv):
    ...
    dataloaders = {
        "train3" : AudioNonSplitDataLoader(datasets["train3"], batch_size=24, num_workers=8, shuffle=True,
                                           pin_memory=args.use_cuda, frame_shift=FRAME_REDUCE_FACTOR),
        "train5" : AudioNonSplitDataLoader(datasets["train5"], batch_size=16, num_workers=8, shuffle=True,
                                           pin_memory=args.use_cuda, frame_shift=FRAME_REDUCE_FACTOR),
        "train10": AudioNonSplitDataLoader(datasets["train10"], batch_size=8, num_workers=4, shuffle=True,
                                           pin_memory=args.use_cuda, frame_shift=FRAME_REDUCE_FACTOR),
        "dev"    : AudioNonSplitDataLoader(datasets["dev"], batch_size=8, num_workers=4, shuffle=True,
                                           pin_memory=args.use_cuda, frame_shift=FRAME_REDUCE_FACTOR),
        "test"   : AudioNonSplitDataLoader(datasets["test"], batch_size=8, num_workers=4, shuffle=True,
                                           pin_memory=args.use_cuda, frame_shift=FRAME_REDUCE_FACTOR),
    }
