...
def train(argv):
    ...
    dataloader_opts = {
        "train3":  { "batch_size": 128, "num_workers": 32, "frame_shift": FRAME_REDUCE_FACTOR },
        "train5":  { "batch_size":  64, "num_workers": 32, "frame_shift": FRAME_REDUCE_FACTOR },
        "train10": { "batch_size":  32, "num_workers": 16, "frame_shift": FRAME_REDUCE_FACTOR },
        "dev":     { "batch_size":  32, "num_workers": 16, "frame_shift": 0                   },
    }
